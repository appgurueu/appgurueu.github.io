...
We first validate the position. [^dir]
...
[^dir]: For the sake of simplicity, assume we allow infinite turning speed, and thus there is no validation to be done on the direction.
